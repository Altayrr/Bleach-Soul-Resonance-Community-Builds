const CHARACTERS = [
  ...
  },
  {
    ...
    setStampGaps: [30, 60],
    setStampInfos: ['<p><span style="color: #EA4A86;">-The recommended Mainstats are:</span><br>1) Srike DMG Bonus%<br>2) ATK%</p><p><span style="color: #EA4A86;">-Substats:</span><br>CR%=ATK% > Crit DMG% > Ailment DMG Bonus%</p>', '<p><span style="color: #EA4A86;">-The recommended Mainstats are:</span><br>1) Crit Rate%</p><p><span style="color: #EA4A86;">-Substats:</span><br>CR%=ATK% > Crit DMG% > Ailment DMG Bonus%</p>', '<p><span style="color: #EA4A86;">-The recommended Mainstats are:</span><br>1) ATK%</p><p><span style="color: #EA4A86;">-Substats:</span><br>CR%=ATK% > Crit DMG% > Ailment DMG Bonus%</p>'],
    setStampPopupWidths: [380, 380, 380],
    setStampAfterText: '<p><span style="color: #EA4A86;">Becoming The King (3/3) </span><br>2-Piece: Increases Strike Mastery by <span style="color: #52C394;">10%</span>.<br>3-Piece: After inflicting Lacerate Points to an enemy and triggering Lacerate, increases ATK by <span style="color: #52C394;">18%</span> and Crit DMG by <span style="color: #52C394;">60%</span> for 30 seconds. Unstackable.</p>',
